...
<section class="container mx-auto">
    <div class="flex flex-wrap my-4 md:my-12">
        <div class="w-full md:hidden px-4">
            ...
            <span class="text-xl">IDR {{ number_format($product->price,0,",",".") }}</span>
        </div>
        <div class="flex-1">
            <div class="slider">
                <div class="thumbnail">
                    ...
                    <div class="px-2">
                        ...
                        data-img="{{ Storage::url($item->url) }}">
                            <img src="{{ Storage::url($item->url) }}" alt="{{ $product->name }}"
                ...
                <div class="preview">
                    <div class="item rounded-lg h-full overflow-hidden">
                        <img src="{{ $product->galleries()->exists() ? Storage::url($product->galleries->first()->url) : 'data:image/gif;base64,R0lGODlhAQABAIAAAMLCwgAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==' }}" alt="{{ $product->name }}"
                            class="object-cover w-full h-full rounded-lg" />
                    </div>
                </div>
            </div>
